...
public class AnaGodoy extends BasicMarioAIAgent implements Agent{
	...
	public boolean[] getAction() {
		int actionNumber = qtable.getNextActionEv(currentState);
		...
		if(Action.values()[actionNumber].toString().contains("JUMP") &&
			...
			actionNumber = 6;	// move right
			return Action.getAction(actionNumber);
		}
